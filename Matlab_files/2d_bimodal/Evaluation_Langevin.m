...
subplot(2,2,2)
Xest2 = reshape(Xest2_exact_path(end,:),[N_x,M2]);
patch([-4 -4 4 4],[-4 4 4 -4],[61 38 168]./255);hold on
p = scatter(Xest2(1,:),Xest2(2,:),'MarkerFaceColor',[0 .9 0],'DisplayName','preconditioned');hold on
...
subplot(2,2,4)
Xest2 = reshape(Xest2_loc_path(end,:),[N_x,M2]);
patch([-4 -4 4 4],[-4 4 4 -4],[61 38 168]./255);hold on
p = scatter(Xest2(1,:),Xest2(2,:),'MarkerFaceColor',[0 .9 0],'DisplayName','derivative-free localised');hold on
